...
import './SuperWriter.css'

class SuperWriter extends React.Component {
    constructor(props) {
        super(props)
    ...
    addIframe = () => {
        let thisApp = document.getElementById(this.state.name)
        thisApp.querySelector('.app-content').innerHTML = `<iframe src='https://docs.google.com/document/d/1aUS7dAtlZBieiFmSSrbCZ6W7qpB6PPUFRNnzE2m9E3A/edit?usp=sharing'></iframe>`
    }
    ...
    render() {
        ...
        return (
            <div onClick={this.activateApp} id={this.state.name} className={'app ' + this.state.visibility}
                ...
                <iframe title="SuperWriter" src='https://docs.google.com/document/d/1aUS7dAtlZBieiFmSSrbCZ6W7qpB6PPUFRNnzE2m9E3A/edit?usp=sharing'></iframe>
                </div>
