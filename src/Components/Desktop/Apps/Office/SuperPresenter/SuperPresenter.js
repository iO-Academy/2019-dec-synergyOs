...
import './SuperPresenter.css'

class SuperPresenter extends React.Component {
    constructor(props) {
        super(props)
    ...
    addIframe = () => {
        let thisApp = document.getElementById(this.state.name)
        thisApp.querySelector('.app-content').innerHTML = `<iframe src='https://docs.google.com/presentation/d/1QCAeGpoyKS8qzed-tfYjPwwmtnU28YMCSXxAivd8kQs/edit?usp=sharing'></iframe>`
    }
    ...
    render() {
        ...
        return (
            <div onClick={this.activateApp} id={this.state.name} className={'app ' + this.state.visibility}
                ...
                <iframe title="SuperWriter" src='https://docs.google.com/presentation/d/1QCAeGpoyKS8qzed-tfYjPwwmtnU28YMCSXxAivd8kQs/edit?usp=sharing'></iframe>
                </div>
