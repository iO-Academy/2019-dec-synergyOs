...
import './SuperDraw.css'

class SuperDraw extends React.Component {
    constructor(props) {
        super(props)
    ...
    render() {
        ...
        return (
            <div onClick={this.activateApp} id={this.state.name} className={'app ' + this.state.visibility}
                ...
                <iframe title="SuperWriter" src='https://docs.google.com/drawings/d/1URTCgrEl6H-jjqz-FUHLx468ZxrUykfUnD1wzgkbIyo/edit?usp=sharing'></iframe>
                </div>
