...
import './SuperSpreadSheet.css'

class SuperSpreadSheet extends React.Component {
    constructor(props) {
        super(props)
    ...
    addIframe = () => {
        let thisApp = document.getElementById(this.state.name)
        thisApp.querySelector('.app-content').innerHTML = `<iframe src='https://docs.google.com/spreadsheets/d/1XjpGyRaFnevd8IiZMzdrYNZ-wRJGfpVP66oDO-lUwTU/edit?usp=sharing'></iframe>`
    }
    ...
    render() {
        ...
        return (
            <div onClick={this.activateApp} id={this.state.name} className={'app ' + this.state.visibility}
                ...
                <iframe title="SuperSpreadSheet" src='https://docs.google.com/spreadsheets/d/1XjpGyRaFnevd8IiZMzdrYNZ-wRJGfpVP66oDO-lUwTU/edit?usp=sharing'></iframe>
                </div>
...
export default SuperSpreadSheet