...
class Calculator extends React.Component {
    ...
    addIframe = () => {
        let thisApp = document.getElementById(this.state.name)
        thisApp.querySelector('.app-content').innerHTML = `<iframe src='https://www.windows93.net/c/programs/calculate/index.php'></iframe>`
    }

    render() {

        let appMinWidths = {minWidth: '100px', minHeight: '100px', maxHeight: '255px'}
